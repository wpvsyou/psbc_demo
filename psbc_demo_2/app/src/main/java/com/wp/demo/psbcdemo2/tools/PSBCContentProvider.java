...
public class PSBCContentProvider extends ContentProvider {
	...
	public static final String AUTHORITY = PSBCCount.DATABASE_NAME + "local";
    ...
    private static final int COMMAND_LOCK = 4;
    private static final int COMMAND_UN_LOCK = 5;
	...
	static {
        ...
        sUriMatcher.addURI(AUTHORITY, PSBCCount.Command.LOGOUT, COMMAND_LOGOUT);
        sUriMatcher.addURI(AUTHORITY, PSBCCount.Command.LOCK, COMMAND_LOCK);
        sUriMatcher.addURI(AUTHORITY, PSBCCount.Command.UNLOCK, COMMAND_UN_LOCK);
	}
